...
Components can be deployed to systems with conventional processing devices capable of hosting a UNIX OS. % Ressource Transp.
...
% - toolchain does not reuse previously generated stuff
% - model domains are seperate, there is no fundamental model
%   hosting both
