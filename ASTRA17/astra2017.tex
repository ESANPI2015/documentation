...
%\end{tikzpicture}
	...
	\subfigure[Behavior graph of a phaser ...]{
		\includegraphics[width=0.1\textwidth]{pics/phaser.png}
	}
	...
	\subfigure[The allpass filter uses a lowpass ...]{
		\includegraphics[width=0.2\textwidth]{pics/lowpass.png}
	}
	\subfigure[... whose output is fed into an ideal opamp.]{
...
\begin{tikzpicture}
    ...
    \draw[-, dashed, red, very thick] (0.5,-0.75) -- (1.75,0.65);
    \draw[-, dashed, red, very thick] (0.5,-1.1) -- (1.72,-0.6);
    \draw[-, dashed, red, very thick] (0.85,-1.1) -- (3.2,-0.71);
\end{tikzpicture}
\caption{
