\begin{tikzpicture}
    ...
    \node[align=center, fill=olive, diamond, inner sep=0pt, minimum size=3mm] (FPGA21) at (-2,1.7) {
    };
	\node[align=center, fill=olive, diamond, inner sep=0pt, minimum size=3mm] (FPGA22) at (-2.4,1.6) {
    };
    \node[align=center, fill=olive, diamond, inner sep=0pt, minimum size=3mm] (FPGA23) at (-3,1.4) {
    };
    \node[align=center, fill=olive, diamond, inner sep=0pt, minimum size=3mm] (FPGA24) at (-1.5,-0.3) {
    };
    \node[align=center, fill=olive, diamond, inner sep=0pt, minimum size=3mm] (FPGA25) at (-2,-1) {
    };
    
    % Connections
    \draw[-, thick] (X86) -- (FPGA1) -- (FPGA2) -- (FPGA3) -- (FPGA4) -- (UC3);
   	\draw[-, thick] (X86) -- (FPGA21) -- (FPGA22) -- (FPGA23) -- (FPGA24) -- (FPGA25) -- (UC1);
